...
export default function HeroSection() {
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-margin-mobile pt-32 pb-20 md:px-gutter">
      ...
      <div className="z-10 mx-auto flex max-w-4xl flex-col items-center space-y-stack-md text-center">
        ...
        >
          <Link href="#preorder" className="btn-primary px-8 py-4 font-label-sm text-label-sm uppercase tracking-widest">
            Đặt trước ngay
          </Link>
          <Link
            href="#features"
